...
public class MemberDTO implements Serializable {
	...
	*/
	...
	public MemberDTO(String mb_Id, String mb_Pw, String mb_Name, String mb_Birth, int mb_Zip, String mb_Addr1,
			...
			String mb_Account, int mb_cash, int mb_cashback) {
		super();
		this.mb_Id = mb_Id;
		this.mb_Pw = mb_Pw;
		...
		this.mb_cash = mb_cash;
		this.mb_cashback = mb_cashback;
	}
	...
	public int getMb_cash() {
		return mb_cash;
	}

	public void setMb_cash(int mb_cash) {
		this.mb_cash = mb_cash;
	}

	public int getMb_cashback() {
		return mb_cashback;
	}

	public void setMb_cashback(int mb_cashback) {
		this.mb_cashback = mb_cashback;
	}
	...
	public String toString() {
		return "MemberDTO [mb_Id=" + mb_Id + ", mb_Pw=" + mb_Pw + ", mb_Name=" + mb_Name + ", mb_Birth=" + mb_Birth
				+ ", mb_Zip=" + mb_Zip + ", mb_Addr1=" + mb_Addr1 + ", mb_Addr2=" + mb_Addr2 + ", mb_Addr3=" + mb_Addr3
				+ ", mb_Hp=" + mb_Hp + ", mb_Email=" + mb_Email + ", mb_Date=" + mb_Date + ", mb_Bank=" + mb_Bank
				+ ", mb_Account=" + mb_Account + ", mb_cash=" + mb_cash + ", mb_cashback=" + mb_cashback + "]";
	}
