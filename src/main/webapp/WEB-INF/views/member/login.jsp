						...
						<form class="form-signin" action="/member/loginpost" method="post">
							...
							<div class="btn-group btn-group-justified">
								<a class="btn btn-lg btn-info btn-block text-uppercase"
									href="/member/findid">아이디 찾기</a> <a
									class="btn btn-lg btn-info btn-block text-uppercase"
									href="/member/selectpw">비밀번호 찾기</a>
							</div>
							<hr class="my-4">
							<a class="btn btn-lg btn-default btn-block text-uppercase"
								href="/">메인페이지로 돌아가기</a>
						</form>
					</div>
				</div>
